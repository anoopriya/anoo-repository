...
class Application @Inject() (
  ...
  @no.samordnaopptak.apidoc.ApiDoc(doc =
    """
    GET /v1/hello-world-service

    DESCRIPTION
      Check to see if hello-world-service service is running
  ...
  def index = Action.async {
    implicit request =>
      timeout {
        val response = "hello-world-service is up and running!"
  ...
  @no.samordnaopptak.apidoc.ApiDoc(doc =
    ...
    """
    GET /v1/hello-world-service/logLevel/{level}
  ...
  @no.samordnaopptak.apidoc.ApiDoc(doc =
    ...
    """
    PUT /v1/hello-world-service/logLevel/{level}
  ...
  def changeLogLevel(levelString: String) = Action.async {
    implicit request =>
      timeout {
        Logger.debug("hello-world-service change log level called")
  ...
  @no.samordnaopptak.apidoc.ApiDoc(doc =
    ...
    """
    GET /v1/hello-world-service/clear_toggles
  ...
  @no.samordnaopptak.apidoc.ApiDoc(doc = """
    GET /v1/hello-world-service/toggles
